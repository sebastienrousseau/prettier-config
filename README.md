...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@sebastienrousseau/prettier-config"><img src="https://img.shields.io/npm/v/%40sebastienrousseau%2Fprettier-config.svg?style=for-the-badge&color=fc8d62&logo=npm" alt="npm package" /></a>
  <a href="https://sebastienrousseau.com/prettier-config/"><img src="https://img.shields.io/badge/docs-sebastienrousseau.com-brightgreen.svg?style=for-the-badge&logo=github" alt="Documentation" /></a>
...
- [Consistent Code Formatting](#consistent-code-formatting) — before and after rule comparison
...
Install `@sebastienrousseau/prettier-config` as a development dependency:
...
`@sebastienrousseau/prettier-config` is a focused satellite of the [`@sebastienrousseau/config`](https://github.com/sebastienrousseau/config) suite — a unified ecosystem of 21 single-purpose, zero-overhead developer configurations designed to share a single design philosophy, strict typing, and zero runtime dependencies.
...
`@sebastienrousseau/prettier-config` solves this with three deliberate engineering choices:
...
When your project intentionally enforces non-standard formatting rules (such as tabs-only with 8-space indents or no semicolons).
