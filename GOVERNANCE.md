...
This document describes how @sebastienrousseau/prettier-config is run: who decides what, how
...
@sebastienrousseau/prettier-config is **maintainer-led**. As of the current release line it has a single
